...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AdminComponent(http, spinner) {
      ...
      _createClass(AdminComponent, [{
        ...
        key: "authenticationButton",
        value: function authenticationButton() {
          var _this = this;

          this.spinner.show(); // Reperisce i dati dal db

          this.http.get("https://infinite-savannah-92995.herokuapp.com/visiting").subscribe(function (data) {
            //   console.log(data)
            _this.response = data;
          });
          var params = {
          ...
          this.http.post("https://infinite-savannah-92995.herokuapp.com/visiting/login", params).subscribe(function (data) {
            _this.spinner.hide(); //    console.log(data)


            if (data == true) {
              _this.hideTable = true;
              _this.password = "";
            } else alert("Password non valido!!!");
          });
        }
      }]);
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AppComponent(spinner) {
        ...
        this.LOGO = "assets/Sanmarco-informatica_logo.jpg"; // Registro 
      }
      ...
      _createClass(AppComponent, [{
        ...
        key: "ngAfterViewInit",
        value: function ngAfterViewInit() {//  this.spinner.hide()
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ngx-spinner */
    "./node_modules/ngx-spinner/fesm2015/ngx-spinner.js"); // 2.
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_8__["HomeComponent"], _admin_admin_component__WEBPACK_IMPORTED_MODULE_9__["AdminComponent"], _contact_contact_component__WEBPACK_IMPORTED_MODULE_10__["ContactComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forRoot(routes), _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], ngx_spinner__WEBPACK_IMPORTED_MODULE_12__["NgxSpinnerModule"]],
      providers: [{
        ...
        value: function call() {
          ...
          this.http.post(url_heroku, params).subscribe(function (data) {
            if (data == true) {
              ...
              _this2.http.post(url_pi, params, {
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function onText() {
          ...
          fileReader.onload = function (e) {
            ...
            var outputFile = ""; // Controlla che inizi sempre per IE815

            if (fileAsString[1].substring(0, 5) !== "IE815") {
              _this3.file = null; //   console.log(fileAsString[1].substring(0, 4))
        ...
        value: function onUpload() {
          ...
          fileReader.onload = function (e) {
            ...
            var outputFile = "";
            var iii = -1; // Read line by line and construct file
            ...
            for (var line = 0; line < fileAsArrayString.length; line++) {
              ...
              iii = iii + 1; // preparo il file di output
              // salto la prima riga
                ...
                case 0:
                  {
                    ...
                    outputFile = outputFile + currentLine; // save the piva

                    var aux = currentLine.split(/(\s+)/).filter(function (e) {
                      return e.trim().length > 0;
                    });
                    _this4.pIva = aux[3].trim();

                    _this4.getConfig(_this4.hint, _this4.pIva);
                  }
                  continue;
                ...
                case 1:
                  {
                    ...
                    var nGaranti = parseInt(split[80].trim()); //  console.log("\n Iterazione[" + line + "] nGaranti vale :  " + nGaranti + "\n")
                    // se ho iterazioni garanti, per trovare l'iterazione successiva devo moltiplicare questo numero
                    // per
                    // i campi da saltare
                    //   var posDau = 81;

                    var posGaranti = 80; // trovo iterazione successiva (Dau)

                    var posDau = _this4.findNextIteration(parseInt(split[posGaranti].trim()), 10, posGaranti); // trovo iterazione successiva (Trasporto)


                    var posTrasporto = _this4.findNextIteration(parseInt(split[posDau].trim()), 3, posDau); // trovo iterazione successiva (Certificati)


                    var posCert = _this4.findNextIteration(parseInt(split[posTrasporto].trim()), 9, posTrasporto); // controllo iterazioni Certificati


                    var nCert = parseInt(split[posCert].trim()); // intanto mi salvo i dati fino a qui.

                    for (var j1 = 0; j1 <= posCert; j1++) {
                      //  console.log("######  Sono in FOR: " + iii + " e split[j1] vale PRIMA DEL METODO: \n" + currentLine+ "\n")
                      finalLine = finalLine + (split[j1] + "\t"); //    console.log("######  Sono in FOR: " + iii + " e split[j1] vale DOPO IL METODO: \n" + currentLine+ "\n")
                    }

                    var posRecC = posCert + 1; // se ho certificati devo andare ad aggiornare il tracciato

                    if (nCert > 0) {
                      // trovo la fine dei certificati
                      posRecC = posRecC + nCert * 6; // per ogni record di certificato scrivo i primi campi as is
                    ...
                    finalLine = finalLine + _this4.elabRecordC(posRecC, split);
                ...
                default:
                  {
                    // code block
                    if (currentLine.trim() !== "") {
                      finalLine = finalLine + (split[0] + "\t" + split[1] + "\t" + _this4.elabRecordC(2, split));
                      outputFile = outputFile + finalLine;
                    }
                  }
                  break;
            ...
            Object(file_saver__WEBPACK_IMPORTED_MODULE_2__["saveAs"])(new Blob([outputFile], {
        ...
        key: "elabRecordC",
        value: function elabRecordC(posRecC_N, split_N) {
          var posImba = posRecC_N + 22;
          var finalC = ""; // scrivo la prima parte fissa
          ...
          var posVino = posImba + 1; // se ho imballaggi devo andare ad aggiornare il tracciato

          if (nImba > 0) {
            // trovo la fine dei certificati
            posVino = posVino + nImba * 7; // per ogni record di imballaggi scrivo i primi campi as is
        ...
        key: "findNextIteration",
        value: function findNextIteration(nIter, fieldIter, posIter) {
          if (nIter > 0) return posIter + 1 + nIter * fieldIter;
          return posIter + 1;
        }
      }, {
        key: "getConfig",
        value: function getConfig(docName, p_iva) {
          var article = {
            piva: p_iva,
            docname: docName
          };
          ...
          */
          ...
          this.http.post("https://infinite-savannah-92995.herokuapp.com/visiting/insert", article).subscribe(function (data) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_common__WEBPACK_IMPORTED_MODULE_3__["DOCUMENT"]))], HomeComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\tommal\Desktop\jexp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
